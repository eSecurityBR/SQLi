...
CREATE DATABASE IF NOT EXISTS `sqli` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `sqli`;
...
(1, 'admin', 'pwd1'),
(2, 'usuario1', 'gasd12'),
(3, 'usuario2', 'postuy666'),
(4, 'usuario3', 'tmrchio82'),
(5, 'usuario4', 'kd2jam'),
(6, 'usuario5', '31lowrem'),
(7, 'usuario6', '4muniz4'),
(8, 'usuario7', 'ciuppi75'),
(9, 'usuario8', 'berfectqui2'),
(10, 'usuario9', 'ioryunzfrunz');
